...
import { HostedRoute } from "@/components/gatherly/hosted-route";
  ...
  return (
    <HostedRoute>
      <main className="min-h-svh px-5 py-6 sm:px-8">
        ...
        <section className="mx-auto flex min-h-[calc(100svh-6rem)] max-w-3xl flex-col items-center justify-center py-8 text-center">
